...
while(1) 
{
	...
	switch(x)  
	{
		...
		break;
  		...
  		case 4:
					printf("\nioctl_wr ile timer talimati vermek icin 1\nioctl_rd ile timer bilgisini almak icin 2 "
  		...
  		case 5:
    		...
    		{
				printf("Bir sey pollü uyandirdi. Ne ola ki?\n");

				if(pfd.revents & POLLIN)
        		{
					printf("Okunamaya hazir data varmis!\n");
					read(fd,read_data_torbasi,100);
					printf("Alinan paketlerin icerigi: %s\n",read_data_torbasi);
				}
			}   
    	break;  
